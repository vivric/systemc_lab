...
/**
 * @class memory
 * Object for isolating memory operations from TLM "shell"
 */
SC_MODULE (memory) {
	// Member Methods  ====================================================
...
public:
	...
	//
	//=====================================================================
	memory(sc_module_name name, sc_time read_delay ///< delay for reads
			, sc_time write_delay ///< delay for writes
	...
	///
	///===================================================================
	void operation(tlm::tlm_generic_payload &gp ///< TLM2 GP reference
...
private:
	...
	sc_time m_read_delay; ///< read delay
	sc_time m_write_delay; ///< write delay
